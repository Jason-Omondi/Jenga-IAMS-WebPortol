...
<div id="header_logo"><img src="../img/header_logo.jpg" class="img-responsive" alt="logo" style="float:left;width:75px; height:50px; border-radius: 25px; position:relative;left:0px"/>
...
<ul id="menu_list">
  <a class="menu_items_link" href="instructions_page.php"><li class="menu_items_list" style="background-color:darkslategrey;padding-left:16px">Instructions</li></a>
  <a class="menu_items_link" href="download_letter.php"><li class="menu_items_list" style="background-color:darkslategrey;padding-left:16px">DOWNLOADS</li></a>
  <a class="menu_items_link" href="return_form.php"><li class="menu_items_list" style="background-color:darkslategrey;padding-left:16px">Return form</li></a>
